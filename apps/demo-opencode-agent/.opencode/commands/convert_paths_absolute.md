...
description: Converts relative paths in .opencode/settings.json command scripts to absolute paths
---

# convert_paths_absolute

This command converts all relative paths in .opencode/settings.json command scripts to absolute paths using the current working directory. It helps ensure that command scripts work correctly regardless of where they are executed from.

## Instructions
- Get the current working directory using pwd
- Read the .opencode/settings.json file
