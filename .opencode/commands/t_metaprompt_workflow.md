...
Slash Command Documentation: https://docs.anthropic.com/en/docs/opencode/slash-commands
Create Custom Slash Commands: https://docs.anthropic.com/en/docs/opencode/common-workflows#create-custom-slash-commands
Available Tools and Settings: https://docs.anthropic.com/en/docs/opencode/settings
