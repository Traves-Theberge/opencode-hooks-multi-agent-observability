...
def main():
    try:
        ...
        if args.notify:
            ...
            elif notification_type == 'idle_prompt' and message != 'OpenCode is waiting for your input':
                announce_notification()
            elif not notification_type and message != 'OpenCode is waiting for your input':
