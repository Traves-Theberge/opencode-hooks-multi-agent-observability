...
TEAM_MEMBERS: `.opencode/agents/team/*.md`
...
4. Define Team Members - Use `ORCHESTRATION_PROMPT` (if provided) to guide team composition. Identify from `.opencode/agents/team/*.md` or use `general-purpose`. Document in plan.
...
<continue with additional tasks as needed. Agent types must exist in .opencode/agents/team/*.md>
